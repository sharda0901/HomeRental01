...
namespace project_on_property_rental_and_sale
{
    public partial class paym : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            OleDbConnection con = new OleDbConnection("Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\\Users\\Admin\\Documents\\payment.mdb");

            con.Open();

            OleDbCommand cmd = new OleDbCommand("insert into payment1(fname,lname,cardno,cvv,billingaddress,mobile,pincode) values(@fname,@lname,@cardno,@cvv,@billingaddress,@mobile,@pincode)", con);
