<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="appart.aspx.cs" Inherits="project_on_property_rental_and_sale.appart" %>
        ...
        <table class="style36">
            <tr>
                <td class="style38">
                    <br />
                    <img alt="" class="style40" 
                        src="apprt5.jpg" /><br /><br />
                    <p class="title" style="font-size: small"> 
                    Posted on 23rd Apr , 2021 by RERA REgister Delered</p> 
                    EARTH REALITY
                </td>
                <td class="style39">
                <h3>3 BHK Residential Appartment Flat in Pune</h3>
                <p>Sunshine Imperial Green</p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br />
    ...
    <div class="card">
      ...
      <div class="container" align="center">
          ...
          <img alt="" class="style41" 
              src="apprt1.jpg" /><h3 align="left" 
              style="width: 257px; font-size: medium;">Mera Apartment</h3> 
  ...
  <div class="column">
    <div class="card">
      ...
      <div class="container">
        <img alt="" class="style41" 
              src="apprt3.jpg" /><h3 align="left" 
              style="width: 257px; font-size: medium;"> Rajkunj Apartment</h3> 
  ...
  <div class="column" >
    <div class="card">
      ...
      <div class="container" >
         <img alt="" class="style41" 
              src="apprt2.png" /><h3 align="left" 
              style="width: 257px; font-size: medium;">&nbsp;&nbsp;Uptwon Apartment</h3> 
